    ...
    >
      ...
      <g filter="url(#soft-shadow)">
        ...
        <rect
          ...
          stroke="#EBC2C7"
        />
        <text x="374" y="448" textAnchor="middle" className="visual-script">
          B
        </text>
        <text x="374" y="486" textAnchor="middle" className="visual-brand-text">
          BLISSFUL BURN
        </text>
      </g>
    </svg>
    ...
    >
      ...
      <g filter={`url(#${safeId}-shadow)`}>
        ...
        <text
          ...
          y="232"
          textAnchor="middle"
          className="visual-script visual-script-small"
        >
          B
        </text>
        <text
          ...
          y="256"
          textAnchor="middle"
          className="visual-brand-text visual-brand-text-small"
        >
          BLISSFUL BURN
        </text>
        <text
    ...
    >
      ...
      <g>
        ...
        <rect
          ...
          stroke="#EBC2C7"
        />
        <text x="256" y="316" textAnchor="middle" className="visual-script">
          B
        </text>
        <text x="256" y="350" textAnchor="middle" className="visual-brand-text">
          BLISSFUL BURN
        </text>
      </g>
    </svg>
