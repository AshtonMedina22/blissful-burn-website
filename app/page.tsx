...
const valuePoints = [
  {
    title: "Small-batch poured",
    detail: "Made slowly for a cleaner, more even burn",
  },
  {
    title: "Layered fragrance",
    detail: "Soft luxury scent profiles that feel refined, not loud",
  },
  {
    title: "Gift-ready design",
    detail: "Minimal vessels and packaging made for beautiful rituals",
  },
  {
    title: "Beyond candles",
    detail: "Wax melts, fragrance essentials, and cozy merch coming soon",
  },
];
      ...
      <div className="page-wrapper">
        ...
        <section className="hero-section">
          <div className="hero-content">
            <p className="eyebrow">
              Soy blend candles · wax melts · fragrance rituals
            </p>
            <h1 className="hero-headline">
              Soft luxury for your everyday unwind.
            </h1>
            <p className="hero-description">
              Blissful Burn creates feminine, clean, and modern home
              fragrance—crafted to make your space feel warm, calm, and quietly
              elevated.
            </p>
        ...
        <section
          ...
          aria-label="Blissful Burn ritual words"
        >
          ...
          <div className="section-header section-header-split">
            <div>
              ...
              <h2 className="section-display-title">
                A polished fragrance and lifestyle destination.
              </h2>
            </div>
            <p className="section-subtitle">
              Built for candles now, with room to introduce wax melts, room
              sprays, cozy apparel, and limited seasonal drops.
            </p>
          </div>
        ...
        >
          <div className="section-header">
            ...
            <h2 className="section-display-title">
              Signature scents, elevated.
            </h2>
            <p className="section-subtitle">
              Curated fragrance profiles for thoughtful gifting and everyday
              calm.
            </p>
          </div>
        ...
        <section className="values-section">
          <div className="section-header">
            ...
            <h3 className="section-display-title">
              Feminine, clean, soft, and timeless.
            </h3>
          </div>
        ...
        <section className="about-section editorial-section">
          ...
          <div className="about-content">
            ...
            <h3 className="about-display-title">
              Designed for the version of home that feels like an exhale.
            </h3>
        ...
        <section className="social-section">
          ...
          <h3 className="section-display-title">
            First access to restocks, drops, and soft-life rituals.
          </h3>
          <p className="section-subtitle">
            New scents, seasonal wax melts, and Blissful Burn relax wear are on
            the way.
          </p>
